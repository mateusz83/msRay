...
typedef struct
{
	...
	int32*		distance_shading_walls__LUT__READY;
...
static int32	GR_Init_Once_Wall_Stripe_LUT(void)
{
	...
	GR_max_wall_stripe_lineheight = (int32)(1000 + (GR_render_width - 320) );
...
static void		GR_Wall_Box_Top_Ray_Intersection(int32 _ray_x, int32 _hit_map_id, float32 _ray_dir_x, float32 _ray_dir_y, float32 ray_dir_y__1div, int8* _is_solid_hit)
{
	...
	if (intersect_result == 0)
	{
		...
		*_is_solid_hit = 1;
		...
		GR_wall_column_1st_pass[_ray_x].distance_shading_walls__LUT__READY = distance_shading_walls__LUT__READY;
...
static void		GR_Wall_Box_Short_Top_Ray_Intersection(int32 _ray_x, int32 _hit_map_id, float32 _ray_dir_x, float32 _ray_dir_y, float32 ray_dir_y__1div, int8* _is_solid_hit)
{
	...
	if (intersect_result == 0)
	{
		...
		GR_wall_column_2nd_pass[GR_wall_column_2nd_pass_count].distance_shading_walls__LUT__READY = distance_shading_walls__LUT__READY;
...
void	GR_Walls_Render(void)
{
	...
	while (ray_x--)
	{
		...
		int32* distance_shading_walls__LUT__READY = GR_wall_column_1st_pass[ray_x].distance_shading_walls__LUT__READY;
	...
	while (ray_x--)
	{
		...
		int32*		distance_shading_walls__LUT__READY = GR_wall_column_2nd_pass[ray_x].distance_shading_walls__LUT__READY;
