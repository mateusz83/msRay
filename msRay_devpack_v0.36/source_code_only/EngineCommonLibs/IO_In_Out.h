...
// --------------------------
...
#if defined _WIN32
	#if defined _DEBUG
		#define IO_GRAPHICS_DIRECTORY		"..\\..\\TheGameOutput\\data\\graphics\\"
	...
	#else
		#define IO_GRAPHICS_DIRECTORY		"data\\graphics\\"
...
#define IO_TEXTURE_MAX_COLORS				32
#define IO_TEXTURE_MAX_COLORS_BITSHIFT		5
#define IO_TEXTURE_MAX_SHADES				256
...
#define IO_TEXTURE_IMAGE_DATA_BYTE_SIZE		(128 * 128 + 64 * 64 + 32 * 32)							// (128*128 + 64*64 + 32*32) * 1 byte
...
typedef struct
{
	...
	int8	mouse_left;
	int8	mouse_right;
} _IO_BYTE_ALIGN_ sIO_Input;

// Defined in: EN_Engine_Main.h
...
typedef struct
{
	...
	int8		screen_buffers_number;

	int8		engine_state;
} _IO_BYTE_ALIGN_ sIO_Prefs;
