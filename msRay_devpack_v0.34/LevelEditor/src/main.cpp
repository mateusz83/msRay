...
void APP_Reset()
{
    ...
    strcpy(APP_level_file.title_01, "Level Title 01");
    strcpy(APP_level_file.title_02, "Level Title 02");
}
        ...
        if (file_result)
        {
            ...
            for (int y = 0; y < MAP_LENGTH; y++)
            {
                for (int x = 0; x < MAP_LENGTH; x++)
                {
                    ...
                    if (APP_level_file.map[index].cell_type > 0)
                    {
                        ...
                        if ((APP_level_file.map[top_index].cell_type <= 0) && APP_level_file.map[top_index].is_lightmapped && (y > 0))
                        {
                            if (_mode == 0)
                            {
                        ...
                        if ((APP_level_file.map[bottom_index].cell_type <= 0) && APP_level_file.map[bottom_index].is_lightmapped && (y < LV_MAP_LENGTH - 1))
                        {
                            if (_mode == 0)
                            {
                        ...
                        if ((APP_level_file.map[left_index].cell_type <= 0) && APP_level_file.map[left_index].is_lightmapped && (x > 0))
                        {
                            if (_mode == 0)
                            {
                                fprintf(file_out, "v %.2f %.2f %.2f\n", (double)(x * grid), (double)((y + 1.0) * mirror_grid), (double)(1.0 * grid));
                        ...
                        if ((APP_level_file.map[right_index].cell_type <= 0) && APP_level_file.map[right_index].is_lightmapped && (x < LV_MAP_LENGTH - 1))
                        {
                            if (_mode == 0)
                            {
                                fprintf(file_out, "v %.2f %.2f %.2f\n", (double)((x + 1.0) * grid), (double)(y * mirror_grid), (double)(0.0 * grid));
...
void GUI_Create(HWND _hwnd)
{
    ...
    // --- LEVEL FILE SIZE INFO ----
        ...
        int file_groupbox_x = 980, file_groupbox_y = 124;
        ...
        int mem_groupbox_x = 980, mem_groupbox_y = 255;
        ...
        CreateWindowEx(0, L"STATIC", L"Wall textures:", WS_CHILD | WS_VISIBLE | SS_LEFT,
                        mem_groupbox_x + 10, mem_groupbox_y + 18, 90, 20, _hwnd, (HMENU)IDS_RES_WALL_TEX_LABEL, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_RIGHT,
                        mem_groupbox_x + 110, mem_groupbox_y + 18, 90, 20, _hwnd, (HMENU)IDS_RES_WALL_TEX, GetModuleHandle(NULL), nullptr);


        CreateWindowEx(0, L"STATIC", L"Flat textures:", WS_CHILD | WS_VISIBLE | SS_LEFT,
                        mem_groupbox_x + 10, mem_groupbox_y + 36, 90, 20, _hwnd, (HMENU)IDS_RES_FLAT_TEX_LABEL, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_RIGHT,
                        mem_groupbox_x + 110, mem_groupbox_y + 36, 90, 20, _hwnd, (HMENU)IDS_RES_FLAT_TEX, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"Wall lightmaps:", WS_CHILD | WS_VISIBLE | SS_LEFT,
                         mem_groupbox_x + 10, mem_groupbox_y + 60, 90, 20, _hwnd, (HMENU)IDS_RES_W_LIGHTMAPS_LABEL, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_RIGHT,
                         mem_groupbox_x + 110, mem_groupbox_y + 60, 90, 20, _hwnd, (HMENU)IDS_RES_W_LIGHTMAPS, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"Flat lightmaps:", WS_CHILD | WS_VISIBLE | SS_LEFT,
                        mem_groupbox_x + 10, mem_groupbox_y + 78, 90, 20, _hwnd, (HMENU)IDS_RES_F_LIGHTMAPS_LABEL, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_RIGHT,
                        mem_groupbox_x + 110, mem_groupbox_y + 78, 90, 20, _hwnd, (HMENU)IDS_RES_F_LIGHTMAPS, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"Total:", WS_CHILD | WS_VISIBLE | SS_LEFT,
                        mem_groupbox_x + 10, mem_groupbox_y + 102, 90, 20, _hwnd, (HMENU)IDS_RES_MEM_TOTAL_LABEL, GetModuleHandle(NULL), nullptr);

        CreateWindowEx(0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_RIGHT,
                         mem_groupbox_x + 110, mem_groupbox_y + 102, 90, 20, _hwnd, (HMENU)IDS_RES_MEM_TOTAL, GetModuleHandle(NULL), nullptr);


        CreateWindowEx(0, L"BUTTON", L"Refresh", WS_CHILD | WS_VISIBLE,
                        mem_groupbox_x + 8, mem_groupbox_y + 124, 193, 24, _hwnd, (HMENU)IDB_RES_MEM_REFRESH, GetModuleHandle(NULL), NULL);
    ...
    // --- TITLE ----
        ...
        int title_groupbox_x = 980, title_groupbox_y = 12;

        CreateWindowEx( 0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_ETCHEDFRAME,
                        title_groupbox_x, title_groupbox_y, 210, 100, _hwnd, (HMENU)-1, GetModuleHandle(NULL), nullptr);
        ...
        CreateWindowEx( 0, L"EDIT", L"", WS_BORDER | ES_AUTOHSCROLL | WS_CHILD | WS_VISIBLE,
                        title_groupbox_x + 10, title_groupbox_y + 26, 190, 22, _hwnd, (HMENU)IDS_TITLE_EDIT_1, GetModuleHandle(NULL), nullptr);

        CreateWindowEx( 0, L"EDIT", L"", WS_BORDER | ES_AUTOHSCROLL | WS_CHILD | WS_VISIBLE,
                        title_groupbox_x + 10, title_groupbox_y + 56, 190, 22, _hwnd, (HMENU)IDS_TITLE_EDIT_2, GetModuleHandle(NULL), nullptr);
    ...
    // ---- LAYERS ----
        ...
        CreateWindowEx( 0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_ETCHEDFRAME,
                        layers_groupbox_x, layers_groupbox_y, 200, 100, _hwnd, (HMENU)IDS_LAYERS_GROUPBOX, GetModuleHandle(NULL), nullptr);
        ...
        CreateWindow(   WC_COMBOBOX, TEXT(""), CBS_DROPDOWNLIST | CBS_HASSTRINGS | WS_CHILD | WS_OVERLAPPED | WS_VISIBLE,
                        layers_groupbox_x + 15, layers_groupbox_y + 38, 170, 100, _hwnd, (HMENU)IDC_LAYERS_COMBO, GetModuleHandle(NULL), NULL);
    ...
    // ---- LIST BOX ----
        ...
        CreateWindowEx( 0, L"STATIC", L"", WS_CHILD | WS_VISIBLE | SS_ETCHEDFRAME,
                        list_groupbox_x, list_groupbox_y, 320, 100, _hwnd, (HMENU)IDS_LIST_GROUPBOX, GetModuleHandle(NULL), nullptr);
        ...
        CreateWindowEx( WS_EX_CLIENTEDGE, L"LISTBOX", NULL, WS_CHILD | WS_VISIBLE | WS_VSCROLL | LBS_NOTIFY,
                        list_groupbox_x + 15, list_groupbox_y + 15, 290, 95, _hwnd, (HMENU)IDL_LIST_LIST, GetModuleHandle(NULL), nullptr);
...
void Map_Reset(void)
{
    ...
    for (int i = 0; i < LV_MAP_CELLS_COUNT; i++)
    {
        APP_level_file.map[i].cell_type = 0;
        APP_level_file.map[i].was_floor_negative = 1;
        APP_level_file.map[i].was_ceil_negative = 1;
...
void Map_Read_Current_Cell()
{
    ...
    else
    {
        ...
        {
            case LAYERS_MAIN_LAYER:
                if (APP_level_file.map[selected_cell_index].cell_type)
                {
