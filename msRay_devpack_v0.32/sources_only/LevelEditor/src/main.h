...
enum LAYERS					{ LAYERS_MAIN_LAYER, LAYERS_FLOOR_LAYER, LAYERS_CEIL_LAYER, LAYERS_LIGHTMAPS_LAYER };
...
enum LIST_LIGHTMAPS_LAYER	{ LIST_LIGHTMAPS_SELECT, LIST_LIGHTMAPS_WALLS, LIST_LIGHTMAPS_FLOOR, LIST_LIGHTMAPS_CEIL };

//sLV_Cell__File_Only MAP_editor_cell[LV_MAP_CELLS_COUNT];
...
// text info
TCHAR map_text_layers[4][16] = { L"Main layer", L"Floor layer", L"Ceiling layer", L"Lightmaps layer" };
