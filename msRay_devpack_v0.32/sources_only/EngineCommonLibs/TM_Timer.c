...
// ----------------------------------------
    ...
    LARGE_INTEGER TM_frequency;

    LARGE_INTEGER TM_current_time;
    LARGE_INTEGER TM_prev_time;
#endif
...
// ----------------------------------------
    ...
    struct timerequest* TM_time_requester;

    struct timeval TM_current_time;
    struct timeval TM_prev_time;
#endif
