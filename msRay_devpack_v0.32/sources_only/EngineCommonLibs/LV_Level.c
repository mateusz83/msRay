...
void	LV_Load_Level_Prepare_Cells(void);
...
int8 LV_Load_Level(int8 _level_number)
{
	...
	PL_player.angle = (float32)LV_Level__File_Only.player_starting_angle * 3;		
	PL_player.angle = (PL_player.angle * MA_pi) / 180.0f;
